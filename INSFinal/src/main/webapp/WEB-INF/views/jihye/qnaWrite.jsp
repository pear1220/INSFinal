  ...
  $(document).ready(function(){
      ...
      //   스마트 에디터 구현 시작(no frame)  
        ...
        //   스마트 에디터 구현 끝(no frame)  --%>
         ...
         // 글제목 유효성 검사
         var qna_titleval = document.getElementById("qna_title").value.trim();
         ...
         //스마트에디터 사용시 무의미하게 생기는 p태그 제거
           ...
           // === 확인용 ===
           // alert(qna_content.value); // qna_content에 내용을 아무것도 입력치 않고 쓰기할 경우 알아보는것.
           // "<p>&nbsp;</p>" 이라고 나온다.
           
           //스마트에디터 사용시 무의미하게 생기는 p태그 제거하기전에 먼저 유효성 검사를 하도록 한다.
           // 글내용 유효성 검사 
           if(qna_content.value == "" || qna_content.value == "<p>&nbsp;</p>") {
              alert("글내용을 입력하세요");
              return;
           }   

         qna_content.value = qna_content.value.replace(/<p><br><\/p>/gi, "<br>"); //<p><br></p> -> <br>로 변환
         qna_content.value = qna_content.value.replace(/<\/p><p>/gi, "<br>"); //</p><p> -> <br>로 변환
         qna_content.value = qna_content.value.replace(/(<\/p><br>|<p><br>)/gi, "<br><br>"); //</p><br>, <p><br> -> <br><br>로 변환
         qna_content.value = qna_content.value.replace(/(<p>|<\/p>)/gi, ""); //<p> 또는 </p> 모두 제거시
           ///////////////////////////////////////////////////////////////
         ...
         <div class="row" >
            <div class="col" >
               ...
               <div class="row" >
                ...
                <%-- <form name="writeFrm"> --%> 
               <%-- ==== #134. 파일첨부하기
                                     먼저, 위의 <form name="writeFrm"> 을 주석처리한 후 아래와 같이 한다.
                         enctype="multipart/form-data" 을 해줘야만 파일첨부가 된다. ==== --%>
                <form  name="WriteFrm" enctype="multipart/form-data">
                   <table id="table" >
                        ...
                        <tr>
                           <th>제목</th>
                           <td><input type="text" name="qna_title" id="qna_title" class="long" /></td>
                        </tr>
                        <tr>
                              <th>내용</th>
                              <td>
                              <textarea name="qna_content" id="qna_content" rows="10" cols="100" style="width:95%; height:412px;"></textarea> 
				...
				if(window.frameElement){
					...
					var oEditor = createSEditor2(jindo.$("qna_content"), {
            ...
            <tr>
                <th>파일첨부</th>
                <td><input type="file" name="attach"  /></td> <%--name은 db컬럼과 똑같이 해야 한다. --%>
            </tr>
