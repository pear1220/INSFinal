...
alter table ins_member drop column tel3; --멤버테이블의 기존 전화번호 컬럼 삭제
alter table ins_member add tel1 varchar2(5);
alter table ins_member add tel2 varchar2(5);
alter table ins_member add tel3 varchar2(5); --varchar2로 타입 바꿔서 전화번호 컬럼 재생성
...
alter table ins_member modify tel3 not null; --전화번호컬럼에 not null제약조건 추가
